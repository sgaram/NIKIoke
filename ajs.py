...
import youtube_dl
#FUNKZHER BOT
cl = LineClient(authToken='EzdfjAnhNUm3ipzepzrc./tnhgFNpEQYjiCeEi7iIha.e4lrEKHIaZ5477n4XkpsOtTxkcHYg51K/NaGaicvXy0=')
#cl = LineClient(authToken='ISI TOKENMU  DISINI')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EzLZV2Gpy3ApXfSRjXUf./JXwkfp+u4nfpiyYCt3rhW.7V25i18pmaV+pEenfyWoNt6Pgi5cL2C6Qkt24T6M1To=')
#ki = LineClient(authToken='ISI TOKENMU  DISINI')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EzNvNldrZJYatafFIdk9.hBhkoFGOWq2ca/v2aGDfkq.2ROcc46J27yBGu4fDGK9UmyQan1zdErDhscgSZX7slI=')
#kk = LineClient(authToken='ISI TOKENMU  DISINI')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EzsD4WvUTPDhh5eJ12tc.RjjX/PW5a9d/mkreQyncZa.T2IymA7PPi6uUGmDzYu/UJhf7uCPiD+o8ZZi3D3yOuk=')
#kc = LineClient(authToken='ISI TOKENMU  DISINI')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='EzIR7DQ1obMhppRDSO4f.SrrNO62JoBMwTM0dc/1lxW.FzFMYzPQ0bvY9kybXfVkGjQnSfxN5ylFsvCQHyFkXsI=')
...
#UPDATE FOTO
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        elif cmd == "kibar" or text.lower() == 'kibar':
                            cl.sendText(msg.to,"sini semvak nya,, aku yg kibar") 
                        elif cmd == "kan" or text.lower() == 'kan':
                            cl.sendText(msg.to,"kan, apaan...")
                        elif cmd == "sem" or text.lower() == 'sem':
                            cl.sendText(msg.to,"PRUL") 
                        elif cmd == "assalamualaikum" or text.lower() == 'asalamualaikum':
                            cl.sendText(msg.to,"waalaikumsalam") 
                        elif cmd == "ngopi" or text.lower() == 'kopi':
                            cl.sendText(msg.to,"malas ngopi, aim demen nenen") 
                        elif cmd == "jomblo" or text.lower() == 'mblo':
                            cl.sendText(msg.to,"kalau mau laku, harus genit mblo..") 
                        elif cmd == "iya" or text.lower() == 'hooh':
                            cl.sendText(msg.to,"iya puskun aja sono EGP") 
                        elif cmd == "nah" or text.lower() == 'bah':
                            cl.sendText(msg.to,"nah kamu kesurupan ya") 
                        elif cmd == "aduh" or text.lower() == 'hadeh':
                            cl.sendText(msg.to,"atit ya,, kurang dalam tuh..") 
                        elif cmd == "sue" or text.lower() == 'suek':
                            cl.sendText(msg.to,"ditambal dul,, klu suek,. ") 
                        elif cmd == "dudul" or text.lower() == 'vekok':
                            cl.sendText(msg.to,"mending dikit daripada kampret") 
